<?php
/**
 * Plugin Name:       The Events Calendar Extension: Community Events Notifications
 * Plugin URI:        
 * GitHub Plugin URI: https://github.com/mt-support/tec-labs-community-events-notifications
 * Description:       
 * Version:           1.0.0
 ...
 * @since 1.0.0
 */
function tribe_extension_community_events_notifications() {
	...
	Tribe__Autoloader::instance()->register_prefix(
		'\\Tribe\\Extensions\\Community_Events_Notifications\\',
	...
	if ( ! class_exists( '\Tribe\Extensions\Community_Events_Notifications\Plugin' ) ) {
		tribe_transient_notice(
			'community-events-notifications',
			'<p>' . esc_html__( 'Couldn\'t properly load "The Events Calendar Extension: Community Events Notifications" the extension was deactivated.', '__TRIBE_DOMAIN__' ) . '</p>',
			[],
	...
	tribe_register_provider( '\Tribe\Extensions\Community_Events_Notifications\Plugin' );
}

// Loads after common is already properly loaded.
add_action( 'tribe_common_loaded', 'tribe_extension_community_events_notifications' );
